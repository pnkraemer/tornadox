...
def test_predict(iwp):
    ...
    chol = tornado.sqrt.predict(A=transition_matrix, SC=some_chol, SQ=process_noise_cholesky)
    cov = transition_matrix @ some_chol @ some_chol.T @ transition_matrix.T + process_noise_cholesky @ process_noise_cholesky.T
